...
- Name: auth-suite.spec.ts >> Authentication Suite @auth >> shows error on empty credentials then logs in successfully
- Location: e2e/tests/auth-suite.spec.ts:16:7
